      ...
      <main className="room-layout">
        <aside className="room-cover">
          <span className="eyebrow">
            {copied ? "Código copiado" : "Sala ativa"}
          </span>
          <h1>{room?.name || "Sala"}</h1>
          <p>
            Compartilhe o código e acompanhe as perguntas. As ações de leitura e
            exclusão ficam na lista ao lado.
          </p>
          ...
          <button
            ...
            onClick={() =>
              setConfirmAction({
                ...
                title: "Excluir sala",
                description:
                  "Informe a senha da sala para excluir esta sala e todas as perguntas.",
                danger: true,
              })
            }
          >
          ...
          <div className="questions-list">
            {questions.length === 0 ? (
              <div className="empty-state">
                ...
                <p>
                  Envie a primeira pergunta ou compartilhe o código da sala com
                  a galera.
                </p>
              </div>
            ) : (
              questions.map((question) => (
                <article
                  className={`question-card ${question.read ? "is-read" : ""}`}
                  key={question.id}
                >
                  <p>{question.text}</p>
                        ...
                        <button
                          ...
                          onClick={() =>
                            setConfirmAction({
                              ...
                              description:
                                "Informe a senha da sala para marcar esta pergunta como lida.",
                            })
                          }
                          title="Marcar como lida"
                        >
                      ...
                      <button
                        ...
                        onClick={() =>
                          setConfirmAction({
                            ...
                            description:
                              "Informe a senha da sala para excluir esta pergunta.",
                            danger: true,
                          })
                        }
                        title="Excluir pergunta"
